...
namespace DCPU_floppy_editor
{
	class cDirectoryEntry
	{
		...
		internal ushort[] GetDirectoryBinData(ushort FirstSector, uint Size)
		{
			...
			Result[6] = (ushort)CreateDateTime;
			Result[7] = (ushort)(CreateDateTime >> 16);
			Result[8] = (ushort)AccessDateTime;
			Result[9] = (ushort)(AccessDateTime >> 16);
			Result[10] = (ushort)ModifyDateTime;
			Result[11] = (ushort)(ModifyDateTime >> 16);
			Result[12] = (ushort)Size;
			Result[13] = (ushort)(Size >> 16);
